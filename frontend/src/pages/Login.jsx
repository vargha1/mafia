    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-800 rounded-lg shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl text-red-400" data-testid="login-title">{t('loginTitle')}</h2>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400">
            {t('dontHaveAccount')}{' '}
            <Link to="/register" className="text-red-400 hover:text-red-300" data-testid="register-link">
              {t('register')}
            </Link>
          </p>
        </div>
